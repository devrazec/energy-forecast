...
export default function LisbonPage() {
  ...
  const chartOption = useMemo(() => {
    // Get Lisbon's data
    if (!lisbonData || !lisbonData.Lisbon) {
      return {};
    }
    ...
    const forecastDates = Object.keys(lisbonForecast?.Lisbon || {});
    ...
    return {
      ...
      title: {
        text: "Energy Consumption - Lisbon, Portugal (7 Days + Forecast)",
        left: "center",
        textStyle: {
